...
ROLES = {
    "vision":   {"service": "magi-live-detect", "own_duty": True,  "peer_key": "magi:heartbeat:balthazar:vision"},
    "language": {"service": "magi-llm-api",      "own_duty": True,  "peer_key": "magi:heartbeat:balthazar:language"},
}
